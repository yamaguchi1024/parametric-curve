...
function init() {
  ...
  curves[0].points.push([ 0.8518551208230735, -0.14848850729943494 ]);
  curves[0].points.push([ 1.4223635962366918, -0.00781518459470707 ])
  curves[0].points.push([ 1.4145484116419846, 0.554878106224204 ]);
  curves[0].points.push([ 0.8518551208230735, 0.7346273519024671 ]);
  curves[0].points.push([ 0.2266403532465057, 0.5079869986559611 ]);
  curves[0].points.push([ 0.24227072243592015, -0.01563036918941414 ]);
  curves[0].points.push([ 0.8049640132548308, -0.14848850729943494 ]);

  curves.push(new Curve());
  curves[1].points.push([ -0.8674854900124879, -0.17193406108355616 ]);
  curves[1].points.push([ -1.3832876732631563, 0.00781518459470707 ]);
  curves[1].points.push([ -1.352026934884328, 0.492356629466547 ]);
  curves[1].points.push([ -0.7268121673077601, 0.7346273519024671 ]);
  curves[1].points.push([ -0.2657162762200412, 0.46109589108771876 ]);
  curves[1].points.push([ -0.2657162762200412, -0.02344555378412121 ]);
  curves[1].points.push([ -0.8205943824442451, -0.17193406108355616 ]);

  curves.push(new Curve());
  curves[2].points.push([ -1.852198748945582, -0.6955514289289317 ]);
  curves[2].points.push([ -2.2898490862491796, 0.21882516865179877 ]);
  curves[2].points.push([ -1.9069050411085313, 1.1644625046113577 ]);

  curves.push(new Curve());
  curves[3].points.push([ 1.6490039494831976, -0.7658880902812955 ]);
  curves[3].points.push([ 2.328925009222715, 0.28134664540945536 ]);
  curves[3].points.push([ 1.6568191340779048, 1.2504295351531358 ]);

  curves.push(new Curve());
  curves[4].points.push([ 0.492356629466547, -0.7580729056865885 ]);
  curves[4].points.push([ 0.03907592297353549, -0.3751288605459406 ]);
  curves[4].points.push([ -0.43765033730359754, -0.7580729056865885 ]);
